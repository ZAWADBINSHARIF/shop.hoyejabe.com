<div x-data="$store.cartSlider" class="relative z-50 w-auto h-auto">
    ...
    <template x-teleport="body">
        <div x-show="$store.cartSlider.slideOverOpen" @keydown.window.escape="$store.cartSlider.slideOverOpen=false"
            class="relative z-[99]">
            <div x-show="$store.cartSlider.slideOverOpen" x-transition.opacity.duration.600ms
                @click="$store.cartSlider.slideOverOpen = false" class="fixed inset-0 bg-black/50"></div>
            <div class="fixed inset-0 overflow-hidden">
                <div class="absolute inset-0 overflow-hidden">
                    <div class="fixed inset-y-0 right-0 flex max-w-full pl-10">
                        <div x-show="$store.cartSlider.slideOverOpen"
                            @click.away="$store.cartSlider.slideOverOpen = false"
                                ...
                                <div class="px-4 sm:px-5">
                                    <div class="flex items-start justify-between pb-1">
                                        ...
                                        <div class="flex items-center h-auto ml-3">
                                            <button @click="$store.cartSlider.slideOverOpen=false"
                                ...
                                <div class="relative flex-1 px-4 mt-5 sm:px-5">
                                    <div class="absolute inset-0 px-4 sm:px-5">
                                        <div class="relative h-full flex flex-col">
                                            ...
                                            {{-- Start Total price and checkout --}}
