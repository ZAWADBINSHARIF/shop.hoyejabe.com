<footer class="bg-gradient-to-b from-gray-50 to-white border-t border-gray-100 mt-5" {!! $attributes ?? '' !!}>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="/"
                                class="text-gray-600 hover:text-gray-900 transition-colors duration-200 flex items-center group">
                                <span
                                    class="w-1 h-1 bg-gray-400 rounded-full mr-2 group-hover:w-4 transition-all duration-200"></span>
                                Home
                            </a>
                        </li>
                        <li>
        ...
        <div class="border-t border-gray-200 py-6">
            <div class="flex flex-col md:flex-row justify-around items-center space-y-2 md:space-y-0">
